  ...
  void initState() {
    ...
    comments = [
      Comment(
        id: '1',
        author: 'Gungdeyana',
        content: 'Foto yang menarik kawan...',
        createdAt: DateTime(2024, 11, 12, 15, 50),
      ),
      Comment(
        id: '2',
        author: 'Indah',
        content: 'Ikut meramaikan aja aku wkwk',
        createdAt: DateTime(2024, 11, 15, 7, 10),
      ),
      Comment(
        id: '3',
        author: 'Martha',
        content: 'Hola bestiee',
        createdAt: DateTime(2024, 11, 12, 10, 30),
      ),
    ];
  }
